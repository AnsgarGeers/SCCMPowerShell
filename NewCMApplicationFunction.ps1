...
# Comments: Reference NewCMApplicationFunction.csv for file formatting.
...
Function NewCMApplication ($Path) {
## Import CSV file generated by Service Now
$pkgs = Import-Csv "$Path"
...
NewCMApplication "C:\scripts\singleapplication.csv"
