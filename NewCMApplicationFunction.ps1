...
NewCMApplication -SiteServerName SiteServer -SiteCode SiteCode -SharedContentFolder "\\kiewitplaza\active\Share\SCCMDeployments\ContentSource" -SourceFolderPath "C:\InstallerSource\Microsoft\Microsoft .NET Framework 4.5" -csvPath "C:\scripts\CSVs\netframework4.5.csv"
